...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    cmp #80         ; Compare P0 X position with 80
    bpl ResetXPos   ; If A is greater than 80, reset P0 X pos to 0
    jmp IncXPos     ; Else, continue to increment P0 X position
ResetXPos:
    lda #40         
    sta P0XPos      ; Reset P0 X position to 40
IncXPos:
    inc P0XPos      ; Increment P0 X position by 1
